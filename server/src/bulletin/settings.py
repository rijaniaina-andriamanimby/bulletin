...
SECRET_KEY = 'django-insecure-%peh1!2hl4jq40y*3r@74g=q*wffslo7#ezon8_x4mr28j*(d7'
...
INSTALLED_APPS = [
    ...
    'eleve', 'classe', 'matiere',
    'enseignant', 'note', 'authentification',
...
# JWT pour django rest framework
REST_FRAMEWORK = {

    ...
    <div className='h-screen bg-gray-50 p-6'>
      ...
      <div className="max-w-7xl mx-auto">
        <div className='flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 bg-white shadow px-5 py-4 rounded-2xl'>
          <div>
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-1">Gestion des matières</h1>
            <p className="text-gray-600 text-sm md:text-base">Gérez et suivez tous vos matières dans votre établissement en un seul endroit</p>
          </div>

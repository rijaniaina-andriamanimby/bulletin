...
const ClasseForm = ({ classe, handleSubmit, onClose, handleChange }) => {
            ...
            <div className="bg-white rounded-xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
                <div className="p-6 border-b border-gray-200">
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                        {classe.id
                            ? "Modifiez la classe"
                            : "Remplissez le nom du nouveau classe"}
                    </p>
                </div>
                <form onSubmit={handleSubmit} className="p-6 space-y-4" autoComplete='off'>
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">Nom du classe <span className='text-red-500'>*</span></label>
                        <input
                            type="text"
                            name="nom"
                            value={classe.nom}
